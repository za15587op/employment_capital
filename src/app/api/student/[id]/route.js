...
export async function PUT(req, { params }) {
  try {
    ...
    const { student_firstname, student_lastname, student_faculty, student_curriculum, student_year, student_gpa, student_phone, skills, studentSkills, selectedSkillTypes } = await req.json();
